  ...
  <div style="height: auto">
    ...
    <div class="showPubilsh_Left_div">
       <c:forEach items="${pcultureContent}" var="p">
		    <tr>
		     <div><td><c:out value="${p.publish_time}"/></td></div>
		     <div><td><c:out value="${p.author}" /></td></div>
		     <div><td><c:out value="${p.title}"/></td></div>
		     <div><td><c:out value="${p.Introduction}"/></td></div>
		   </tr>
		 </c:forEach>
    <img src="/resources/pic/sssccc.com_photo_0102248.jpg" width="314" height="209" alt=""/>
    <a href="/pculture1" >繼續閱讀...</a>
    </div>
