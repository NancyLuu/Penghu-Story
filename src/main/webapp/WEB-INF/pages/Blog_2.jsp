        ...
        <div class="row">
            ...
            <div class="col-md-8">
              ...
              <h2>
                ...
                <p class="lead">
                    by <a href="blog-post_1"><td><c:out value="${b.author}" /></td></a>
                </p>
                <p><i class="fa fa-clock-o"></i><td><c:out value="${b.publish_time}"/></td></p>
                <hr>
                <a href="/load_blog?pid=${b.po_id}">
                    <img class="img-responsive img-hover" width="112" height="101" src="/resources/img/${b.file}" alt="">
                </a>
                <hr>
                <p><td><c:out value="${b.Introduction}"/></td></p>
                <a class="btn btn-success" href="/load_blog?pid=${b.po_id}">Read More ...</a>
                <hr>
			</c:forEach>
            </div>
