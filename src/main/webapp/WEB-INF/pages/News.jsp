...
<!-- Navigation -->
    ...
    <div class="container">
        ...
        <!-- Projects Row -->
        <c:forEach items="${newsContent}" var="n">
	        <div class="row">
	           <div class="col-xs-4 img-portfolio">
	                <a href="/load_blog?pid=${n.po_id}">
	                    <img class="img-responsive img-hover" width="112" height="101" src="/resources/img/${n.file}" alt="">
	                </a>
	                <h3>
	                    <a href="portfolio-item.html"><td><c:out value="${n.title}"/></td></a>
	                </h3>
	                <p><td><c:out value="${n.Introduction}"/></td></p>
	                <a class="btn btn-success" href="/load_blog?pid=${n.po_id}">Read More ...</a>
	            </div>
	        </div>
        </c:forEach>
        <!-- /.row -->
